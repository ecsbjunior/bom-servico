...
<html>
    ...
    <body onload="procurarCategorias()">
        <!-- MENU -->
            ...
            <div class="row align-self-center w-100">
                <div class="col-6 mx-auto">
                    <div class="jumbotron jumbotron-lg">
                        <form id="dCategoria" class="text-center border border-light p-5">

                            <p class="h4 mb-4">Controle de Categoria</p>

                            <!-- Login -->
                            <input type="text" class="form-control mb-4" name="cCod" placeholder="Código" readonly>

                            <!-- Password -->
                            <input type="text" class="form-control mb-4" name="cNome" placeholder="Nome da categoria">

                            <!-- Save button -->
                            <button class="btn btn-danger btn-block my-4" type="submit" onclick="salvarCategoria()">Salvar</button>

                            <hr>

                            <form id="dPesquisa">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Digite o nome da categoria" id="cFiltro" name="cPesquisa">
                                </div>
                                <input type="button" class="btn btn-danger btn-block" value="Pesquisar" onclick="procurarCategorias()">
                                ...
                                <div class="style-container-table my-4">
                                    <table class="table bg-danger">
                                        ...
                                        <tbody id="previewCategorias"></tbody>
                                    </table>
                                </div>
        ...
        <!-- My Imports -->
        <script src="JS/ctrlCategoria.js"></script>
